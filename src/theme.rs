...
impl Palette {
    pub fn dark() -> Self {
        Self {
            dark: true,
            window: Color32::from_rgb(0x22, 0x21, 0x2c),
            panel: Color32::from_rgb(0x1e, 0x1d, 0x27),
            surface: Color32::from_rgb(0x28, 0x2a, 0x36),
            surface_hover: Color32::from_rgb(0x38, 0x3a, 0x4c),
            surface_active: Color32::from_rgb(0x45, 0x41, 0x58),
            outline: Color32::from_rgb(0x45, 0x41, 0x58),
            text: Color32::from_rgb(0xf8, 0xf8, 0xf2),
            secondary: Color32::from_rgb(0xc6, 0xc6, 0xc2),
            dim: Color32::from_rgb(0x79, 0x70, 0xa9),
            accent: Color32::from_rgb(0x95, 0x80, 0xff),
            accent_hover: Color32::from_rgb(0xaa, 0x99, 0xff),
            on_accent: Color32::from_rgb(0x22, 0x21, 0x2c),
            danger: Color32::from_rgb(0xff, 0x95, 0x80),
            warning: Color32::from_rgb(0xff, 0xca, 0x80),
            overlay: Color32::from_rgb(0x28, 0x2a, 0x36),
...
macro_rules! icons {
    ($($variant:ident => $file:literal),* $(,)?) => {
        &[$((
            Icon::$variant,
            concat!("bytes://snoop-icon-", $file, ".svg"),
