...
mod mac_impl {
    ...
    define_class!(
        ...
        #[name = "SnoopLinkHandler"]
        pub struct SnoopLinkHandler;

        impl SnoopLinkHandler {
    ...
    pub fn install(commands: Arc<Mutex<Vec<ControlCommand>>>, waker: Waker) {
        ...
        let handler: Retained<SnoopLinkHandler> =
            unsafe { msg_send![mtm.alloc::<SnoopLinkHandler>(), init] };
