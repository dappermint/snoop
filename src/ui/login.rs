        ...
        .show(ui, |ui| {
            ...
            Frame::new()
                ...
                .show(&mut card_ui, |ui| {
                    ...
                    ui.add_space(6.0);
                    theme::text(ui, "Snoop", theme::bold(30.0), palette.text);
                    ...
                    match &app.auth {
                        ...
                        _ => {
                            ...
                            ui.add(
                                egui::Label::new(
                                    egui::RichText::new("Sign in through your browser. Snoop never sees your password. Local playback needs Spotify Premium.")
            ...
            ui.painter().text(
                ...
                format!("Snoop {} • not affiliated with Spotify", env!("CARGO_PKG_VERSION")),
                theme::regular(11.5),
                palette.dim,
            );
        });
