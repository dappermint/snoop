# Copilot instructions for Snoop
...
from a supported capability Snoop has not implemented yet.
...
https://dappermint.github.io/snoop/make-it-even-faster/ for the personal Client ID setup.
